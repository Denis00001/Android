...
public class CustomCalendarView extends LinearLayout {
    ...
    private ArrayList<Events> CollectEventDate(String date){
    ...
    private void InitializeLayout(){
        ...
        NextButton = view.findViewById(R.id.forvard_Button);
    ...
    private void SetUpCalendar(){
     ...
     int FirstDayofTheMonth = monthCalendar.get(Calendar.DAY_OF_WEEK)-1;
     monthCalendar.add(Calendar.DAY_OF_MONTH, -FirstDayofTheMonth);
